    ...
    return (
        <>
            ...
            <div className="d-none d-md-block">
                <CustomButtonTab defaultActiveKey="one" id="uncontrolled-tab-example" className="mb-3">
                    <CustomTab eventKey="one" title="First">
                        <Wrapper>
                    ...
                    <CustomTab eventKey="two" title="Second">
                        <Wrapper>
                    ...
                    <CustomTab eventKey="three" title="Third" >
                        <Wrapper>
                            <img
                                src={tab3}
                                alt={tab3}
